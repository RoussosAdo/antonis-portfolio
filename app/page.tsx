    ...
    <>
      ...
      <main className="min-h-screen bg-neutral-950 text-white">
        ...
        <Reveal delayMs={80}>
          <section
            id="projects"
            className="scroll-mt-24 mx-auto max-w-6xl px-6 pb-24"
          >
            <div className="flex items-end justify-between gap-6">
              <div>
                ...
                <p className="mt-2 max-w-2xl text-white/70">
                  Production-style React work, full-stack fundamentals, and
                  clean JavaScript engineering.
                </p>
              </div>
        ...
        <Reveal delayMs={160}>
          <section
            id="contact"
            className="scroll-mt-24 mx-auto max-w-6xl px-6 pb-20"
          >
